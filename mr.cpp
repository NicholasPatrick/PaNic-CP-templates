...
bool dmr64(u64 n) {
	...
	if (n < 350269456337) return mr64(n, 4230279247111683200) &&
		mr64(n, 14694767155120705706u) && mr64(n, 16641139526367750375u);
	if (n < 55245642489451) return mr64(n, 2) && mr64(n, 141889084524735) &&
		mr64(n, 1199124725622454117) && mr64(n, 11096072698276303650u);
	if (n < 7999252175582851) return mr64(n, 2) && mr64(n, 4130806001517) &&
		mr64(n, 149795463772692060) && mr64(n, 186635894390467037) &&
		mr64(n, 3967304179347715805);
	if (n < 585226005592931977) return mr64(n, 2) &&
		mr64(n, 123635709730000) && mr64(n, 9233062284813009) &&
		mr64(n, 43835965440333360) && mr64(n, 761179012939631437) &&
		mr64(n, 1263739024124850375);
